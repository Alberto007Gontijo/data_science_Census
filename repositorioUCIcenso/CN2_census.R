...
#Transforma a coluna sexo de string para numero
table(base$sex)
unique(base$sex)
...
#Divisão para teste e tratamento
library(caTools)
set.seed(1)
...
#complexidade das regras (nesse caso sera 1, pouco complexa)
